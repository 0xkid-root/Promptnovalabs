  ...
  return (
    <section className="relative w-full flex flex-col items-center justify-center text-center px-6 py-16 md:py-20 overflow-hidden">
      ...
      <h1 className="relative max-w-3xl text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-4">
        Best Claude AI Prompts for Marketing, Email & Copywriting{" "}
        <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-300">
          (2026)
        </span>
      </h1>

      {/* 🔥 SEO + Conversion Subheadline */}
      <p className="relative max-w-xl text-zinc-400 text-sm md:text-base leading-relaxed mb-6">
        Discover high-quality Claude AI prompts for marketing, email sequences,
        blog writing, and business automation. Copy and use instantly — no signup required.
      </p>

      {/* 🔥 Trust Signals */}
      <div className="relative flex items-center gap-6 text-xs text-zinc-500 mb-6">
      ...
      {/* CTAs */}
      <div className="relative flex flex-col sm:flex-row items-center gap-3 mt-2 pb-4">
        <a
          href="#prompts"
      ...
      {/* 🔥 Trust line */}
      <p className="relative text-[11px] text-zinc-600 mt-3">
        Used by creators, marketers & developers worldwide
      </p>
